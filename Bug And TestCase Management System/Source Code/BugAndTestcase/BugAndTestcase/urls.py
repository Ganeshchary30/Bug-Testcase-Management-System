...
urlpatterns = [
    ...
    path("developer_task_update_status/<id>", employee_view.developer_task_update_status, name="developer_task_update_status"),
    path("developer_task_status_insert/", employee_view.developer_task_status_insert, name="developer_task_status_insert"),

    path("tester_task_update_status/<id>", employee_view.tester_task_update_status,
         name="tester_task_update_status"),
    path("tester_task_status_insert/", employee_view.tester_task_status_insert,
         name="tester_task_status_insert"),

    path('view_testcase_details/<int:testcase_id>/', employee_view.view_testcase_details, name='view_testcase_details'),
